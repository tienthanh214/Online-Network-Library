...
class Signup(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.txt_username = tk.Entry(self, width=36, bg="#FFFFFF", font=style.entry_font)
        ...
        self.lbl_password.grid(row=3, column=1, sticky=tk.E+tk.W,
                               padx=10, pady=0, columnspan=2)
        self.txt_password = tk.Entry(self, show="*", width=36, bg="#FFFFFF", font=style.entry_font)
        ...
        self.lbl_checkpas.grid(row=5, column=1, sticky=tk.E+tk.W,
                               padx=10, pady=0, columnspan=2)
        self.txt_checkpas = tk.Entry(self, show="*", width=36, bg="#FFFFFF", font=style.entry_font)
